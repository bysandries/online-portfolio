...
export default function DesktopIcon({ app, onOpen }: { app: AppDef; onOpen: (app: AppDef) => void }) {
  return (
    ...
    >
      <span
        className="flex h-14 w-14 items-center justify-center rounded-[14px] border border-white/15 text-white/90 shadow-[inset_0_1px_0_rgba(255,255,255,.18),0_4px_10px_rgba(0,0,0,.35)] transition-transform duration-150 group-hover:scale-105"
