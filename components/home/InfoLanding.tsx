...
/**
 * "Info Only" landing page: hero + featured work + section links — the
 * classic-site half of the mode toggle. The desktop experience lives in
 * components/desktop/. The full project explorer stays at /projects.
 */
